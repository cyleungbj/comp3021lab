...
public class FindMax {
	...
	public void printMax() {
		...
		Thread find1 = new Thread(task1);
		Thread find2 = new Thread(task2);
		Thread find3 = new Thread(task3);
		...
		int temp = Math.max(task1.getOutput(), task2.getOutput());
		int max = Math.max(task3.getOutput(), temp);
